...
public class lostUser extends JFrame {
	...
	public lostUser() {
		...
		panel_1 = new JPanel();
		panel_1.setBounds(0, 0, 664, 459);
		panel.add(panel_1);
		panel_1.setLayout(null);

		JLabel label = new JLabel("\u8BF7\u8F93\u5165\u8D26\u53F7");
		label.setBounds(179, 153, 112, 32);
		panel_1.add(label);
		label.setFont(new Font("宋体", Font.PLAIN, 20));

		textField = new JTextField();
		textField.setBounds(292, 153, 168, 32);
		panel_1.add(textField);
		textField.setColumns(10);

		sure = new JButton("\u786E\u8BA4");
		sure.setBounds(170, 282, 93, 42);
		panel_1.add(sure);
		sure.setFont(new Font("宋体", Font.PLAIN, 20));
		exit = new JButton("\u9000\u51FA");
		exit.setBounds(376, 282, 93, 42);
		panel_1.add(exit);
